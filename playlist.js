...
const unfollowPlaylist = {
    ...
    description: "Remove a playlist from the current user's library (unfollow). " +
        ...
        try {
            ...
            return {
                content: [
                    {
                        type: 'text',
                        text: `Error unfollowing playlist: ${error instanceof Error ? error.message : String(error)}`,
                    },
                ],
            };
        }
